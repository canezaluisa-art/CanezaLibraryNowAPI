using CanezaLibraryNowAPI.Models;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace CanezaLibraryNowAPI.Controllers
{
    [Route("api/v1/books")]
    [ApiController]
    public class BooksController : ControllerBase
    {
        ...
        {
            new Books { Id = 1, Title = "Noli Me Tangere", Author = "Jose Rizal", Genre = "Novel,Satire,Philippine History", Available = true, PublishedYear = 1887 },
            new Books { Id = 2, Title = "El Filibusterismo", Author = "Jose Rizal", Genre = "Novel,Fiction", Available = true, PublishedYear = 1891 },
